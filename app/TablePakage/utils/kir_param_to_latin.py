KEY_MAPPING = {
    ...
    "Есть рычаг": "has_device",
    "Есть рычаг (да/нет)": "is_has_device", #Параметр чтобы в ткп указать вместо "рычаг" - Да (рычаг) и нет
    "Диапазон давлений": "interval_press"
}
