...
5. **Обработка RULES_TABLE**: для каждого элемента из RULES_TABLE:
   ...
   - Если параметр был найден, то используй его значение, полученное по шагам 2–4 (включая конвертацию и выбор допустимого).
...
RULES_TABLE = [
  ...
  { "name": "Климатическое исполнение (свойства окружающей среды)", "default": "У1 (40…+40 °C)"},
