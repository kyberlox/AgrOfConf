<template>
    <div class="min-h-[86vh] bg-white rounded-lg w-full p-[16px]">
        <div class="flex flex-row justify-start gap-[25px] flex-wrap">
            <div class="max-w-full lg:max-w-[40%] p-4 bg-blue-50 border border-blue-200 rounded-lg shadow-sm">
                ...
                <div class="text-md text-gray-700">
                    Для изменения логики подбора по табличным параметрам необходимо отредактировать исходный excel файл,
                    сперва скачав его, отредактировав и затем загрузив по кнопкам в блоке Excel, добавить или
            ...
            <div class="flex justify-start gap-2">
                <div
                    ...
                    <BaseButton
                        ...
                        <Loader class="button-primary__loader" v-if="exporting" />
        ...
        <div class="mt-[20px] border border-gray-200 p-[20px] rounded-xl">
            ...
            <p v-if="!productStatistics.length" class="text-sm text-gray-500">Пока нет данных о подборах.</p>
            <ul v-else class="flex flex-col gap-2 max-h-[220px] overflow-auto">
                <li
                    v-for="(s, i) in productStatistics"
                    :key="i"
        ...
        <div class="flex flex-col gap-[20px]">
            <div
                ...
                <p class="text-sm">
                    Загрузите Excel‑таблицу в блоке «excel» (кнопка загрузки) — будут созданы таблица и её параметры,
                    либо создайте параметр вручную кнопкой «Создать параметр».
                </p>
            </div>
            <div
                class="flex flex-col gap-2 mt-4 border border-gray-200 p-[20px] rounded-xl"
                v-if="productTableType.length">
                    ...
                    <VueDraggable
                        ...
                        <TransitionGroup
                            ...
                            <ProductParameterCard
                                v-for="parameter in productTableType"
                                :key="parameter.id"
                                :parameter="parameter"
                                @delete="deleteParam"
                                @edit="changeSettings" />
