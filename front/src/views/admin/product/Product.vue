<template>
  <div class="min-h-[86vh] bg-white rounded-lg w-full p-[16px]">
    <div class="flex flex-row justify-start gap-[25px] flex-wrap">
      <div
        class="max-w-full lg:max-w-[40%] p-4 bg-blue-50 border border-blue-200 rounded-lg shadow-sm"
      >
      ...
      <div class="flex justify-start gap-2">
        ...
        >
          ...
          <BaseButton
            :buttonSettings="{ class: 'button-primary', disabled: excellDownloading }"
    ...
    <div class="flex flex-row items-center justify-start gap-[15px]">
      <div
        class="mt-[20px] max-w-[250px] w-[250px]"
