<template>
  <div class="border border-gray-200 p-[20px] rounded-xl">
    <div
      class="flex flex-row flex-wrap items-center justify-between gap-[12px] mb-[12px]"
    >
    ...
    <div v-else class="flex flex-col gap-[12px]">
      ...
      >
        <div
          class="flex flex-row items-center justify-between gap-[8px] mb-[8px] flex-wrap"
        >
        ...
        <div class="flex flex-row flex-wrap gap-[8px] min-h-[40px]">
          ...
          <span v-if="!block.params.length" class="text-xs text-gray-400"
            >Перетащите сюда параметры</span
          >
        </div>
      </div>
    </div>
    ...
    >
      <div class="bg-white rounded-lg p-6 w-full max-w-md shadow-xl">
        ...
        <div class="flex flex-col gap-3">
          ...
          <label
            class="flex flex-row items-center gap-2 text-sm text-gray-700 cursor-pointer"
          >
        ...
        <div class="flex justify-end gap-3 mt-5">
          ...
          <button
            class="px-4 py-2 rounded text-white bg-orange-500 hover:bg-orange-600"
            @click="saveBlock"
          >
            Сохранить
          </button>
