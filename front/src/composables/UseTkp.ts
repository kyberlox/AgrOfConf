...
export const handleDownloadTkp = async (
    variantId: number,
    productId: number,
    userData: userParams,
    ...
    try {
        const response = await Api.post(
            `tkp_generation/create_tkp?file_id=${variantId}&product_id=${productId}&recognition_id=${recognitionId}save_to_statistic=true`,
            userData,
            { responseType: "blob" },
            undefined,
            true,
